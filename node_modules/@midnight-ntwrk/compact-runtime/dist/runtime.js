...
exports.convertFieldToBytes = convertFieldToBytes;
exports.convertBytesToField = convertBytesToField;
exports.convertBytesToUint = convertBytesToUint;
...
function createCoinCommitment(coinInfo, recipient) {
    return ocrt.coinCommitment({
        value: exports.CoinInfoDescriptor.toValue(coinInfo),
        alignment: exports.CoinInfoDescriptor.alignment(),
    }, {
        value: exports.CoinRecipientDescriptor.toValue(recipient),
        alignment: exports.CoinRecipientDescriptor.alignment(),
    });
}
/**
...
function createZswapOutput(circuitContext, coinInfo, recipient) {
    circuitContext.transactionContext = circuitContext.transactionContext.insertCommitment(Buffer.from(exports.Bytes32Descriptor.fromValue(createCoinCommitment(coinInfo, recipient).value)).toString('hex'), circuitContext.currentZswapLocalState.currentIndex);
    circuitContext.currentZswapLocalState = {
        ...circuitContext.currentZswapLocalState,
 ...
 */
const hasCoinCommitment = (context, coinInfo, recipient) => context.transactionContext.comIndicies.has(Buffer.from(exports.Bytes32Descriptor.fromValue(createCoinCommitment(coinInfo, recipient).value)).toString('hex'));
exports.hasCoinCommitment = hasCoinCommitment;
/**
 ...
 * consumption.
 */
exports.Bytes32Descriptor = new CompactTypeBytes(32);
exports.MaxUint8Descriptor = new CompactTypeUnsignedInteger(18446744073709551615n, 8);
exports.CoinInfoDescriptor = {
    alignment() {
        return exports.Bytes32Descriptor.alignment().concat(exports.Bytes32Descriptor.alignment().concat(exports.MaxUint8Descriptor.alignment()));
    },
    fromValue(value) {
        return {
            nonce: exports.Bytes32Descriptor.fromValue(value),
            color: exports.Bytes32Descriptor.fromValue(value),
            value: exports.MaxUint8Descriptor.fromValue(value),
        };
    },
    toValue(value) {
        return exports.Bytes32Descriptor
            .toValue(value.nonce)
            .concat(exports.Bytes32Descriptor.toValue(value.color).concat(exports.MaxUint8Descriptor.toValue(value.value)));
    },
};
exports.ZswapCoinPublicKeyDescriptor = {
    alignment() {
        return exports.Bytes32Descriptor.alignment();
    },
    fromValue(value) {
        return {
            bytes: exports.Bytes32Descriptor.fromValue(value),
        };
    },
    toValue(value) {
        return exports.Bytes32Descriptor.toValue(value.bytes);
    },
};
exports.ContractAddressDescriptor = {
    alignment() {
        return exports.Bytes32Descriptor.alignment();
    },
    fromValue(value) {
...
exports.BooleanDescriptor = new CompactTypeBoolean();
exports.CoinRecipientDescriptor = {
    alignment() {
        return exports.BooleanDescriptor
            .alignment()
            .concat(exports.ZswapCoinPublicKeyDescriptor.alignment().concat(exports.ContractAddressDescriptor.alignment()));
    },
    fromValue(value) {
        return {
            is_left: exports.BooleanDescriptor.fromValue(value),
            left: exports.ZswapCoinPublicKeyDescriptor.fromValue(value),
            right: exports.ContractAddressDescriptor.fromValue(value),
        };
    },
    toValue(value) {
        return exports.BooleanDescriptor
            .toValue(value.is_left)
            .concat(exports.ZswapCoinPublicKeyDescriptor.toValue(value.left).concat(exports.ContractAddressDescriptor.toValue(value.right)));
    },
};
