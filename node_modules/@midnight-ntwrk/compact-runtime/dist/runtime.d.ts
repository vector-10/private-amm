 ...
 */
export declare const hasCoinCommitment: (context: CircuitContext<unknown>, coinInfo: EncodedCoinInfo, recipient: EncodedRecipient) => boolean;
/**
 ...
 * @internal
 */
export declare function convertFieldToBytes(n: number, x: bigint, src: String): Uint8Array;
/**
 * Compiler internal for typecasts
 * @internal
 */
export declare function convertBytesToField(n: number, a: Uint8Array, src: String): bigint;
/**
 * Compiler internal for typecasts
 * @internal
 */
export declare function convertBytesToUint(maxval: number, n: number, a: Uint8Array, src: String): bigint;
/**
 * Field addition
...
export declare const CoinInfoDescriptor: {
    alignment(): ocrt.Alignment;
...
export declare const BooleanDescriptor: CompactTypeBoolean;
export declare const CoinRecipientDescriptor: {
    alignment(): ocrt.Alignment;
    fromValue(value: ocrt.Value): {
        is_left: boolean;
        left: {
